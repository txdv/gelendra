...
The following 2 are absolutely needed by the server in order to serve a game.
* wad -> cstrike
* bsp -> cstrike/maps
...
If he hasn't got the skybox tga's, a default one be used, wav and sprites and models will be ommited if not existent.
