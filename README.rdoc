...
If one wants to collect all files for a map you have to read the file.
The entity section is the most interesting, since everything you need is basically represented in text.
...
The coordinates have all the time 3 sets of floats in text format, don't know what they stay for.
